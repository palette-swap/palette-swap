...
void WorldSystem::restart_game()
{
	...
	create_enemy(ColorState::Red, EnemyType::LivingArmor, uvec2(12, 3));
	create_enemy(ColorState::Red, EnemyType::LivingArmor, uvec2(15, 3));
	create_enemy(ColorState::Red, EnemyType::LivingArmor, uvec2(15, 4));
}
